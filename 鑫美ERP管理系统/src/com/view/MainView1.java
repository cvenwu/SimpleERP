...
import com.main.UpdatePasswordView;;
		 ...
		 * TODO	主界面		1440 * 900
		 */
public class MainView1 extends JFrame implements Runnable{
	 ...
	 */
	public MainView1(final String username, String urole) {
		...
		tabbedPane.setBounds(0, 0, width1, (int)(0.16 * height1));
		...
		final int height2 = (int)(0.73 * height1);
		desktopPane.setBounds(0, (int)(0.165 * height1), width2, height2);
		//正文管理
		...
		//设置页脚布局
		footer_Panel.setBounds(0, (int)(0.9 * height) - 80, (int)(0.9 * width), 60);
...
//					JDialog dialog = new JDialog();
//					JTabbedPane tab = new JTabbedPane();
//					final AddPurchasePanel addPurchasePanel = new AddPurchasePanel();
////					final UpdateAndDeletePortClassifyPanel updateAndDeletePortClassifyPanel = new UpdateAndDeletePortClassifyPanel();
//					tab.addTab("采购登记", addPurchasePanel);
////					tab.addTab("采购修改与删除", updateAndDeletePortClassifyPanel);
//					tab.addChangeListener(new ChangeListener() {
//						@Override
//						public void stateChanged(ChangeEvent e) {
//							// TODO Auto-generated method stub
...
//						}
//					});
//					dialog.setBounds(450, 200, 900, 700);
//					dialog.setVisible(true);
//					dialog.setResizable(false);
//					dialog.add(tab);
					new QueryPurchase();
